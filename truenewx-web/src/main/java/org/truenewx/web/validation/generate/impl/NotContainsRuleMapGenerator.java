 ...
 */
@Component
public class NotContainsRuleMapGenerator implements ValidationMapGenerator<NotContainsRule> {

    @Override
    public Map<String, Object> generate(final NotContainsRule rule, final Locale locale) {
