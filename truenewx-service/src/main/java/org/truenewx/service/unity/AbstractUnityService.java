...
public abstract class AbstractUnityService<T extends Unity<K>, K extends Serializable>
    ...
    @Override
    public T load(K id) throws BusinessException {
        T unity = find(id);
        assertNotNull(unity);
        return unity;
    }
    ...
    @Override
    public T update(K id, T unity) throws HandleableException {
        if (id == null) {
            return null;
        }
     ...
     */
    protected T beforeSave(K id, T unity) throws HandleableException {
     ...
     */
    protected void afterSave(T unity) throws HandleableException {
    }

    @Override
    public T add(SubmitModel<T> submitModel) throws HandleableException {
    ...
    @Override
    public T update(K id, SubmitModel<T> submitModel) throws HandleableException {
        if (id == null) {
            return null;
        }
     ...
     * @throws HandleableException 如果数据验证失败
     */
    protected T beforeSave(K id, SubmitModel<T> submitModel) throws HandleableException {
        T unity;
        if (id == null) {
     ...
     */
    @Nullable
    protected T beforeAdd(SubmitModel<T> submitModel) throws HandleableException {
        throw new UnsupportedOperationException();
    }
     ...
     */
    @Nullable
    protected T beforeUpdate(K id, SubmitModel<T> submitModel) throws HandleableException {
        throw new UnsupportedOperationException();
    }
     ...
     */
    @Override
    public void delete(K id) throws HandleableException {
        if (id != null) {
     ...
     */
    @Nullable
    protected T beforeDelete(K id) throws HandleableException {
        throw new UnsupportedOperationException();
    }
