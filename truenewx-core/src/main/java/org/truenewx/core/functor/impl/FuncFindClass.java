...
public class FuncFindClass implements Function<String, Class<?>> {
     ...
     * 默认实例
     */
    public static FuncFindClass DEFAULT = new FuncFindClass();

    private static Map<String, Class<?>> PRIMITIVE_CLASSES = new HashMap<>();
    private static Map<String, Class<?>> WRAPPED_CLASSES = new HashMap<>();
     ...
     *            原生类型是否转换为对应的包裹类型
     */
    public FuncFindClass(final ClassLoader classLoader, final boolean wrapPrimitive) {
