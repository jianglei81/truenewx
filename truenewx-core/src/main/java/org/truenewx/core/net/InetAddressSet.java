...
public class InetAddressSet {
    ...
    public void add(final InetAddress address) {
        // 遍历已有的地址段，尝试加入其中
        for (final InetAddressRange<?> range : this.ranges) {
    ...
    public void add(final InetAddressRange<?> range) {
        // 遍历已有的地址段，尝试加入其中
        for (final InetAddressRange<?> r : this.ranges) {
