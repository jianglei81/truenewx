...
<form class="form-horizontal" id="form1" action="${context}/tool/region" role="form" method="get">
    ...
    <div class="form-group">
        <div class="col-md-10">
            <textarea class="form-control" id="source" rows="20">110000     　北京市
110100     　　市辖区
110101     　　　东城区
110102     　　　西城区
110105     　　　朝阳区
...
710000     　台湾省
810000     　香港特别行政区
820000     　澳门特别行政区</textarea>
        </div>
    </div>
    <div class="form-group hidden" id="errorBlock">
        <div class="col-md-10">
            <div class="alert alert-danger bottom-block">数据格式不正确，请重新输入</div>
        </div>
    </div>
    <div class="form-group">
        <div class="col-md-10">
