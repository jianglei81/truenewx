            ...
            contents:[{
                ...
                elements:[{
                    ...
                    html:"<div class='btn' style='position: relative;overflow:hidden;border: 1px solid #ccc;cursor: pointer;font-size: 14px;font-weight: normal;line-height: 1.42857;margin-bottom: 0;padding: 6px 12px;text-align: center;vertical-align: middle;white-space: nowrap;'>"+
                          ...
                          "<div id='ckViewLocalImage' style='width:"+maxWidth+";margin-top:10px;text-align:center;border:1px #c9cccf solid;padding:5px;'></div>"
                }]
            },{
                id:"linkImage",
                label:"网络图片",
                    ...
                    onBlur:function(){
                        if(this.getValue()!=""){
                            ...
                            $image.bind("load",function(){
                                ...
                                $image.height(h);
                                $image.width(w);
                                $image.attr("ratio",wRatio>=1?0:(Math.floor(wRatio*100)/100));
            ...
            onLoad:function(){
                $("input[type='file']").imageUpload({
                    ...
                    beginCallback:function(ele){
                        $("#ckViewLocalImage").html("<img src='"+site.path.resContext+"/vendor/ckeditor/4.5.10/plugins/ImageUpload/images/Loading6.gif' loding='true'/>")
                    },
                    successCallback:function(result){
                        ...
                        $image.bind("load",function(){
                                ...
                                $image.attr("ratio",wRatio>=1?0:(Math.floor(wRatio*100)/100));
                                $image.attr("original-height",originalHeight);
                                $("#ckViewLocalImage").find("img[loding='true']").remove();
                                $image.show();
                            });
